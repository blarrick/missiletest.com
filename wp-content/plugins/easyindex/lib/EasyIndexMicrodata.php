...
class EasyIndexMicrodataDOMElement extends DOMElement {
     ...
     *
     * @return A string with the itemid.
     */
     ...
     *
     * @return An array of itemprop tokens.
     */
     ...
     *
     * @return An array of ids as contained in the itemref attribute.
     */
     ...
     *
     * @return An array of EasyIndexDOMElements which are properties of this
     *         element.
     */
     ...
     *
     * @return The string value if the element is not an item, or $this if it is
     *         an item.
     */
